...
export default [
  ...
  //         },
  //         {
  //           url: '/apps/eCommerce-item-detail-view',
  //           name: 'Item Details',
  ...
  //       submenu: [
  //         {
  //           url: '/ui-elements/list-view',
  //           name: 'List View',
  //           slug: 'data-list-list-view',
  //           i18n: 'ListView'
  //         },
  //         {
  //           url: '/ui-elements/thumb-view',
  //           name: 'Thumb View',
  ...
  //         },
  //         {
  //           url: '/ui-elements/card-actions',
  //           name: 'Card Actions',
  //           slug: 'card-actions',
  //           i18n: 'CardActions'
  //         },
  //         {
  //           url: '/ui-elements/card-colors',
  //           name: 'Card Colors',
  //           slug: 'card-colors',
  //           i18n: 'CardColors'
  //         }
  ...
  //         },
  //         {
  //           url: '/extensions/export-selected',
  ...
  //       submenu: [
  //         {
  //           url: '/forms/form-elements/selects',
  //           name: 'Select',
  //           slug: 'form-element-select',
  //           i18n: 'Select'
  //         },
  //         {
  //           url: '/forms/form-elements/switchs',
  //           name: 'Switch',
  //           slug: 'form-element-switch',
  //           i18n: 'Switch'
  //         },
  //         {
  //           url: '/forms/form-elements/checkboxs',
  //           name: 'Checkbox',
  //           slug: 'form-element-checkbox',
  //           i18n: 'Checkbox'
  //         },
  //         {
  //           url: '/forms/form-elements/radios',
  //           name: 'Radio',
  //           slug: 'form-element-radio',
  //           i18n: 'Radio'
  //         },
  //         {
  //           url: '/forms/form-elements/inputs',
  //           name: 'Input',
  ...
  //         },
  //         {
  //           url: '/forms/form-elements/textareas',
  //           name: 'Textarea',
  ...
  //       submenu: [
  //         {
  //           url: '/charts-and-maps/apex-charts',
  //           name: 'Apex Charts',
  ...
  //     },
  //     {
  //       url: '/charts-and-maps/google-map',
  //       name: 'Google Map',
  //       icon: 'MapIcon',
