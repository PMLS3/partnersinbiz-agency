      ...
      <template v-if="cartItems.length">
            ...
            >
              ...
              >
                <img
                  :src="item.image"
                  alt="item"
                  class="p-4 cart-dropdown-item-img"
                />
              </div>

              <!-- INFO COL -->
              <div
                class="flex flex-col justify-center w-4/5 py-4 pl-2 pr-4 vx-col"
              >
                <span class="block font-medium truncate cart-item-title">{{
                  item.name
                }}</span>
        ...
        >
          <span class="flex items-center justify-center">
            <feather-icon icon="ShoppingCartIcon" svg-classes="h-4 w-4" />
