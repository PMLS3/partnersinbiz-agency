...
//   if (bone.parent) {
//     bone.matrix.premultiply(
//       new THREE.Matrix4().getInverse(bone.parent.matrixWorld)
//     )
//   }
...
// const cubeGeometry = new THREE.ConeBufferGeometry(0.05, 0.2, 3).applyMatrix(
...
//         tailBone,
//         bone =>
//           /eye/i.test(bone.name) && regexp.test(bone.name.replace(/eye/gi, ''))
//       )
//       if (eyeBone) {
//         return eyeBone
//       } else {
...
//         tailBone,
//         bone =>
//           /foot|ankle/i.test(bone.name) &&
//           regexp.test(bone.name.replace(/foot|ankle/gi, ''))
//       )
//       if (footBone) {
//         const legBone = _findFurthestParentBone(
//           footBone,
//           bone =>
//             /leg|thigh/i.test(bone.name) &&
//             regexp.test(bone.name.replace(/leg|thigh/gi, ''))
//         )
//         if (legBone) {
...
//       : null
//     const poseSkeleton =
//       poseSkeletonSkinnedMesh && poseSkeletonSkinnedMesh.skeleton
//     if (poseSkeleton) {
...
//           .divideScalar(2)
//       } else {
//         const neckToHeadDiff = Head.getWorldPosition(new THREE.Vector3()).sub(
//           Neck.getWorldPosition(new THREE.Vector3())
//         )
...
//     const leftArmDirection = Left_wrist.getWorldPosition(
//       new THREE.Vector3()
...
//       Left_leg.getWorldQuaternion(new THREE.Quaternion()).premultiply(
//         armature.quaternion.clone().inverse()
//       )
//     )
...
//     const armatureMatrixInverse = new THREE.Matrix4().getInverse(
//       armature.matrixWorld
//     )
...
//         new THREE.VRMSpringBoneImporter()
//           .import(object)
...
//       _averagePoint([
//         modelBones.Left_ankle.getWorldPosition(new THREE.Vector3()),
//         modelBones.Right_ankle.getWorldPosition(new THREE.Vector3())
//       ])
//     ).y
//     this.shoulderWidth = modelBones.Left_arm.getWorldPosition(
//       new THREE.Vector3()
//     ).distanceTo(modelBones.Right_arm.getWorldPosition(new THREE.Vector3()))
...
//               .localToWorld(
//                 localVector.copy(springBone._initialLocalChildPosition)
//               )
...
//           ? this.fingerBones.left
//           : this.fingerBones.right
//         const gamepadInput = left
//           ? this.inputs.rightGamepad
//           : this.inputs.leftGamepad
...
//           let blinkLeftMorphTargetIndex =
//             morphTargetDictionary['vrc.blink_left']
...
//           let blinkRightMorphTargetIndex =
//             morphTargetDictionary['vrc.blink_right']
...
//         mesh.matrixWorld.multiplyMatrices(
//           this.model.matrixWorld,
//           output.matrixWorld
//         )
//       }
//     }
