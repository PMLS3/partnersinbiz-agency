<template>
  <PerfectScrollbar :settings="settings">
    <div
      parent="body"
      default-index="1"
      color="primary"
    ...
    >
      ...
      <div class="flex flex-wrap items-center justify-center p-6" slot="footer">
        <vs-button class="mr-6" @click="newEstimate">Add Invoice</vs-button>
...
export default {
  ...
  components: {
    // Credits: () =>
    //   process.client
    //     ? import('@/components/forms/forms/paper_trail/vendor_credits.vue')
    //     : null,
    // ItemsAdd: () =>
    //   process.client
