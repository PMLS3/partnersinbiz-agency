  ...
  <div>
    <div class="centerx">
      ...
      <div class="vx-row mb-6">
        <div class="vx-col w-full">
          <p>Bank Name</p>
          <vs-input class="w-full" v-model="bank_name" />
        </div>
      </div>
      <div class="vx-row mb-6">
        <div class="vx-col w-full">
          <p>Account Number</p>
          <vs-input class="w-full" type="number" v-model="acc_num" />
        </div>
      </div>
      <div class="vx-row mb-6">
        <div class="vx-col w-full">
      ...
      for (let i = 0; i < items.length; i++) {
        if (items[i]) {
          ...
          let item = {
            ...
            acc_code: acc_code,
            branch: vm.branch,
            acc_curr: items[i].acc_curr,
            bank_name: items[i].bank_name,
            acc_num: items[i].acc_num,
            desc: '',
