  ...
  <div id="knowledge-base-page">
    <client-only>
      ...
      <div class="knowledge-base-jumbotron">
        ...
        >
          <h1 class="mb-1 text-white">Contacts Lists</h1>
          <h2 class="text-xl font-semibild text-white leading-tight">
            Create different contact Lists to keep your contacts organized
          </h2>
...
export default {
  ...
  data() {
    return {
      item: { item: 'Contacts', title: 'Load Folders', type: 'Category' },
