  ...
  <div id="knowledge-base-page">
    <client-only>
      ...
      <div class="knowledge-base-jumbotron">
        ...
        >
          <h1 class="mb-1 text-white">Real Estate Group</h1>
          <h2 class="text-xl font-semibild text-white leading-tight">
            Create different real estate groups
          </h2>
...
export default {
  ...
  data() {
    return {
      item: { item: 'RealEstate', title: 'Load Folders', type: 'Category' },
