<!-- =========================================================================================
    File Name: uploadMusic.vue
    Description: Upload music to firebase
    ----------------------------------------------------------------------------------------
...
<template>
  <div>
    <div class="mt-5">
      ...
      >
        ...
        >
          <div
            ...
            v-if="showPrimary"
          >
            <div class="display-flex align-items-center" v-show="audioDefault">
          ...
          <div class="display-flex">
            <label class="cursor-pointer audio-edit display-flex" :for="idEdit">
              <svg
      ...
      >
        ...
        >
          ...
          <div class="input-add-audio position-absolute full-width full-height">
            <label
              :for="idUpload"
    ...
    <vs-button @click="setAudios" class="my-6" v-if="audios.length > 0"
      >Upload All</vs-button
    >
    <!--  -->
    <div v-for="(audio, index) in audios" :key="index">
      ...
      <div class="vx-row">
        <div class="w-full mb-2 vx-col sm:w-1/2">
          <vs-input
            class="w-full"
            label-placeholder="Record Label"
