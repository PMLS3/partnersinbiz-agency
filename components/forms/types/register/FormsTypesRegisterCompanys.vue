<template>
  ...
  >
    <div class="flex items-center justify-between px-6 mt-6">
      <vs-popup title="Pricing Structure" :active.sync="popupActivo">
        <vs-row>
          <vs-col
            vs-type="flex"
            vs-justify="center"
          ...
          >
            <vs-card>
              <div slot="header">
                <h3 class="text-style">Communities and Complexes</h3>
              </div>
              <div>
                <h2 class="text-style">R499 Monthly</h2>
                <h5 class="text-style">Unlimited users and downloads</h5>
                <h5 class="text-style">
                  Limited Listed Features excl. Online store
                </h5>
                <h6 class="text-style">Email support</h6>
              </div>
            </vs-card>
          </vs-col>
          <vs-col
          ...
          >
            <vs-card>
              <div slot="header">
                <h3 class="text-style">
                  Estates with Amenities (clubhouses, golfcourses, etc)
                </h3>
              </div>
              <div>
                <h2 class="text-style">R899 Monthly</h2>
                <h5 class="text-style">Unlimited users and downloads</h5>
                <h5 class="text-style">
                  All Listed Features excl. Online store
                </h5>
                <h6 class="text-style">Email support</h6>
              </div>
            </vs-card>
          ...
          >
            <vs-card>
              <div slot="header">
                <h3 class="text-style">
                  Specialies Estates (Retirement and Developments)
                </h3>
              </div>
              <div>
                <h2 class="text-style">R1,299 Monthly</h2>
                <h5 class="text-style">Unlimited users and downloads</h5>
                <h5 class="text-style">
                  Consultative Development and Feature Allocation
                </h5>
                <h6 class="text-style">
                  Premium Support & custom development at R1,699 per hour
                </h6>
              </div>
            </vs-card>
          </vs-col>
          ...
          >
            <vs-card>
              ...
              <div>
                <h2 class="text-style">R699 Monthly</h2>
                <h5 class="text-style">
                  Create your OWN pregressive mobile APP for your community
                </h5>
                <h5 class="text-style">Limited Listed Features</h5>
                <h6 class="text-style">Premium support</h6>
              </div>
            </vs-card>
          </vs-col>
        </vs-row>
