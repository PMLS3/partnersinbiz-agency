  ...
  <div id="theme-customizer">
    ...
    <PerfectScrollbar>
      <div class="h-full mx-4">
        ...
        <p class="mt-5">Person</p>
        <v-select class="w-full" v-model="staff" :options="myStaff"></v-select>
  ...
  methods: {
    newEquity() {
      ...
      let equityAdd = {
        ...
        eq_type: vm.equity_type,
        t_cost: vm.cost,
        shares_amount: vm.shares,
        // share_holder: vm.staff,
        ass_type: vm.ass_type,
      ...
      if (vm.ass_type == 'Current Assets') {
        equityAdd.c_asset = vm.current_asset
      }
