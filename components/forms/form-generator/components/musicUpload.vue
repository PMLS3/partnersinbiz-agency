  ...
  <div>
    ...
    >
      ...
      <div v-for="(audio, index) in infoAudios" :key="index">
        <vs-checkbox v-model="checkAudio" :vs-value="audio"
          >{{ audio.title }} - {{ audio.artist }}</vs-checkbox
        >
        <!-- <vs-radio v-model="checkAudio" :vs-value="audio"
          >{{ audio.title }} - {{ audio.artist }}</vs-radio
        > -->
      </div>
      <vs-input v-model="categorySave" label="Add Category" />
      <vs-button @click="AddCategory">Add Category</vs-button>
      ...
      <vs-card class="mt-5">
        ...
        <vs-button @click="setAudios" class="my-6">Upload All</vs-button>
      </vs-card>
      <!--  -->
      ...
      <li v-for="(audio, index) in audios" :key="index">
        <vs-input v-model="audio.name" label="name" />
        <vs-input v-model="audio.artist" label="artist" />
        <vs-input v-model="audio.album" label="album" />
        <vs-input v-model="audio.genre" label="genre" />
         <vs-select
      autocomplete
      class="selectExample"
      label="Category"
      v-model="audio.category"
    >
      <vs-select-item
        :key="index"
        :value="item"
