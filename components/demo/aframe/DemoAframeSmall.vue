<template>
  <client-only>
    ...
    <a-scene cursor="rayOrigin: mouse" raycaster="objects: .clickable">
      ...
      >
        <a-sphere position="5 2 -3" color="mediumseagreen"></a-sphere>
      </a-entity>

      <a-entity id="house-shell" position="0 0 0" visible="false">
        <a-sky
          src="#sky"
          geometry="radius: 200"
          id="skys"
        ...
        <a-entity
          id="house"
          gltf-model="https://cdn.glitch.com/4bdb3f56-b261-46a4-8bf3-8c065554a3ff%2FHouseExterior.glb?v=1607522419536"
          position="1 0 -0.335"
        ...
        <!-- <a-light
        type="ambient"
        position="5.83 3.15 -7.28"
        light="color: #f2f2f2;  intensity: 0.01; distance: 0.5"
        visible=""
      ...
      ></a-light> -->
        ...
        <a-entity
          ...
          position="4.76356 1.6627 -6.42759"
          visible="false"
          rotation=""
          id="collision-world"
        ...
        <a-entity
          geometry="width: 10; height: 0.11"
          position="0.00998 0.74518 0.22059"
          visible="false"
          rotation=""
          id="collision-world2"
