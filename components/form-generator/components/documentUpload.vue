  ...
  <div>
    ...
    >
      ...
      <div class="w-full mt-5" v-if="needUpload">
        ...
        <vs-button @click="setImages" class="my-6">Use Image</vs-button>
      </div>
    </vs-popup>
  </div>
</template>
...
export default {
  ...
  props: {
    ...
    dragText: {
      type: String,
      default: 'Drag documents (multiple)'
    },
    browseText: {
      type: String,
      default: '(or) Select'
