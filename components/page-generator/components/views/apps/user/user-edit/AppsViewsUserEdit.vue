...
<script>
import UserEditTabAccount from './AppsViewsUserEditTabAccount.vue'
import UserEditTabInformation from './AppsViewsUserEditTabInformation.vue'
import UserEditTabSocial from './AppsViewsUserEditTabSocial.vue'
