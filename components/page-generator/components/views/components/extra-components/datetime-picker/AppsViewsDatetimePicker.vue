...
<template>
  <div id="extra-component-datetime-picker-demo">
    <p class="mb-4">
      vue-flatpickr-component is Vue.js component for Flatpickr datetime picker.
...
<script>
import DatetimePickerBasic from './AppsViewsDatetimePickerBasic.vue'
import DatetimePickerDatetime from './AppsViewsDatetimePickerDatetime.vue'
import DatetimePickerTime from './AppsViewsDatetimePickerTime.vue'
import DatetimePickerLocale from './AppsViewsDatetimePickerLocale.vue'
import DatetimePickerStartEnd from './AppsViewsDatetimePickerStartEnd.vue'
import DatetimePickerInline from './AppsViewsDatetimePickerInline.vue'
import DatetimePickerInput from './AppsViewsDatetimePickerInput.vue'
