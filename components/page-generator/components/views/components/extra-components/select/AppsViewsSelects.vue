  ...
  <div id="extra-component-select-demo">
    <p class="mb-4">
      <a
        ...
        >vue-select</a
      >
      is a native Vue.js select component that provides similar functionality to
      Select2. Read full documnetation
      <a
...
<script>
import SelectDropdownOptions from './AppsViewsSelectDropdownOptions.vue'
import SelectSelectingValues from './AppsViewsSelectSelectingValues.vue'
