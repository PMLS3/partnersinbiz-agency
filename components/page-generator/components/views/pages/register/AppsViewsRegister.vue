...
<script>
import RegisterJwt from './AppsViewsRegisterJWT.vue'
import RegisterFirebase from './AppsViewsRegisterFirebase.vue'
import RegisterAuth0 from './AppsViewsRegisterAuth0.vue'
