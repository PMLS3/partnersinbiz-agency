...
<script>
//Tailwind
import ButtonsTailwind from '@/components/page-generator/components/views/components/tailwind/button/AppsViewsButtons.vue'
import FormsTailwind from '@/components/page-generator/components/views/components/tailwind/forms/AppsViewsForms.vue'
import NavigationTailwind from '@/components/page-generator/components/views/components/tailwind/navigation/AppsViewsNavigation.vue'
...
//Grid
import grid from '@/components/page-generator/components/views/ui-elements/grid/tailwind/AppsViewsGridTailwind'
import grid2 from '@/components/page-generator/components/views/ui-elements/grid/vuesax/AppsViewsGridVuesax'
...
// //Card Components
import cardActionsAdd from '@/components/page-generator/components/views/ui-elements/card/AppsViewsCardActions'
import cardAnalyticsAdd from '@/components/page-generator/components/views/ui-elements/card/AppsViewsCardAnalytics'
import cardBasicAdd from '@/components/page-generator/components/views/ui-elements/card/AppsViewsCardBasic'
import cardColorsAdd from '@/components/page-generator/components/views/ui-elements/card/AppsViewsCardColors'
import cardStatisticsAdd from '@/components/page-generator/components/views/ui-elements/card/AppsViewsCardStatistics'
...
import autocompleteAdd from '@/components/page-generator/components/views/components/extra-components/autocomplete/AppsViewsAutocomplete'
import carouselAdd from '@/components/page-generator/components/views/components/extra-components/carousel/AppsViewsCarousel'
import clipboardAdd from '@/components/page-generator/components/views/components/extra-components/clipboard/AppsViewsClipboard'
import contextMenuAdd from '@/components/page-generator/components/views/components/extra-components/context-menu/AppsViewsContextMenu.vue'
import datePickerAdd from '@/components/page-generator/components/views/components/extra-components/datepicker/AppsViewsDatepicker'
import dateTimePickerAdd from '@/components/page-generator/components/views/components/extra-components/datetime-picker/AppsViewsDatetimePicker'
import dragAndDropAdd from '@/components/page-generator/components/views/components/extra-components/drag-and-drop/AppsViewsDragAndDrop'
import exportAdd from '@/components/page-generator/components/views/components/extra-components/import-export/AppsViewsExport'
...
// //VUESAX
import alertAdd from '@/components/page-generator/components/views/components/vuesax/alert/AppsViewsAlert'
import avatarAdd from '@/components/page-generator/components/views/components/vuesax/avatar/AppsViewsAvatar'
import breadcrumbAdd from '@/components/page-generator/components/views/components/vuesax/breadcrumb/AppsViewsBreadcrumb'
import buttonAdd from '@/components/page-generator/components/views/components/vuesax/button/AppsViewsButton.vue'
import buttonGroupAdd from '@/components/page-generator/components/views/components/vuesax/button-group/AppsViewsButtonGroup.vue'
import chipAdd from '@/components/page-generator/components/views/components/vuesax/chip/AppsViewsChip.vue'
import collapseAdd from '@/components/page-generator/components/views/components/vuesax/collapse/AppsViewsCollapse.vue'
import dialogsAdd from '@/components/page-generator/components/views/components/vuesax/dialogs/AppsViewsDialogs.vue'
import dividerAdd from '@/components/page-generator/components/views/components/vuesax/divider/AppsViewsDivider.vue'
import dropdownAdd from '@/components/page-generator/components/views/components/vuesax/dropdown/AppsViewsDropdown.vue'
import listAdd from '@/components/page-generator/components/views/components/vuesax/list/AppsViewsList.vue'
import loadingAdd from '@/components/page-generator/components/views/components/vuesax/loading/AppsViewsLoading.vue'
import imageAdd from '@/components/page-generator/components/views/components/vuesax/images/AppsViewsImages.vue'
import navbarAdd from '@/components/page-generator/components/views/components/vuesax/navbar/AppsViewsNavbar.vue'
import notificationsAdd from '@/components/page-generator/components/views/components/vuesax/notifications/AppsViewsNotifications.vue'
import paginationAdd from '@/components/page-generator/components/views/components/vuesax/pagination/AppsViewsPagination.vue'
import popupAdd from '@/components/page-generator/components/views/components/vuesax/popup/AppsViewsPopup.vue'
import progressAdd from '@/components/page-generator/components/views/components/vuesax/progress/AppsViewsProgress.vue'
import sidebarAdd from '@/components/page-generator/components/views/components/vuesax/sidebar/AppsViewsSidebar.vue'
import sliderAdd from '@/components/page-generator/components/views/components/vuesax/slider/AppsViewsSlider.vue'
import tabsAdd from '@/components/page-generator/components/views/components/vuesax/tabs/AppsViewsTabs.vue'
import tooltipAdd from '@/components/page-generator/components/views/components/vuesax/tooltip/AppsViewsTooltip.vue'
import uploadAdd from '@/components/page-generator/components/views/components/vuesax/upload/AppsViewsUpload.vue'
