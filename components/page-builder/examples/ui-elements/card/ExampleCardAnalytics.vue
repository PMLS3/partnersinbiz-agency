    ...
    <div class="vx-row">
      ...
      <div class="vx-col w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
        <vx-card title="Sales" subtitle="Last 6 Months">
          ...
          <div class="flex">
            <span class="flex items-center"
              ><div class="h-3 w-3 rounded-full mr-2 bg-primary"></div>
          ...
          >
            ...
            >
              ...
              <p class="mb-4 text-3xl font-semibold">
                {{ goalOverview.analyticsData.completed.toLocaleString() }}
              </p>
            </div>
            <div
            ...
            >
              ...
              <p class="mb-4 text-3xl font-semibold">
                {{ goalOverview.analyticsData.inProgress.toLocaleString() }}
              </p>
            </div>
          </div>
        </vx-card>
    ...
    <div class="vx-row">
      <div class="vx-col w-full md:w-1/2 mb-base">
        <vx-card>
          <div class="vx-row flex-col-reverse lg:flex-row">
            ...
            <!-- RIGHT COL -->
            <div
              class="vx-col w-full lg:w-1/2 xl:w-1/2 flex flex-col lg:mb-0 mb-base"
            >
      ...
      <div class="vx-col w-full md:w-1/2 mb-base">
        <vx-card class="overflow-hidden">
          <template slot="no-body">
            <div
              class="flex justify-between items-center p-6 border border-solid d-theme-border-grey-light border-r-0 border-l-0 border-t-0"
            >
              <div>
                <p>
                  <span class="font-semibold"
                    >{{ todoToday.numComletedTasks }} task completed</span
                  >
                  out of {{ todoToday.totalTasks }}
                </p>
        ...
        <vx-card title="Sales" class="mb-base">
          ...
          <div slot="no-body" class="p-6 pb-0">
            <vue-apex-charts
              type="line"
              height="266"
              :options="analyticsData.salesLine.chartOptions"
          ...
          <template slot="no-body" v-if="Object.entries(funding).length">
            <div class="p-8 clearfix">
              ...
              <p
                ...
                :class="
                  funding.comparison.resultPerc >= 0
                    ? 'text-success'
                    : 'text-danger'
                "
              >
            ...
            >
              <div class="mb-4">
                ...
                <vs-progress
                  :percent="funding.meta.earned.progress"
                  color="success"
                ></vs-progress>
              </div>
              <div>
                ...
                <vs-progress
                  :percent="funding.meta.duration.progress"
                  color="warning"
                ></vs-progress>
              </div>
            </div>
