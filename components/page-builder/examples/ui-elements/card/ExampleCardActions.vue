  ...
  <div class="vx-row">
      ...
      >
        <table style="width:100%" class="border-collapse">
          <tr>
            ...
            <th
              class="p-2 border border-solid d-theme-border-grey-light text-center"
            >
              Icon
            </th>
            <th class="p-2 border border-solid d-theme-border-grey-light">
    ...
    <div class="vx-col w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
      <vx-card title="Collapsable Card" collapse-action>
        <p class="mb-3">
          You can create collapsible content card by setting
          <code>collapse-action</code> prop to <code>true</code>. By default it
          is set to false.
        </p>
        <p class="mb-3">
          You can also get this action if you set
          <code>action-buttons</code> prop to <code>true</code>.
        </p>
        <p>
          Click on
          <feather-icon
            ...
            class="align-middle"
          />
          icon to see card collapse in action.
        </p>
      </vx-card>
    </div>
    ...
    <div class="vx-col w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
      <vx-card title="Remove Card" remove-card-action>
        <p class="mb-3">
          You can add remove card action by setting
          <code>remove-card-action</code> prop to <code>true</code>. By default
          it is set to false.
        </p>
        <p class="mb-3">
          You can also get this action if you set
        ...
        <p>
          ...
          <feather-icon
            ...
            class="align-middle"
          />
          icon to see close card in action.
        </p>
      </vx-card>
    </div>
    ...
    <div class="vx-col w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
      ...
      >
        <p class="mb-3">
          You can add refresh content action by setting
          <code>refresh-content-action</code> prop to <code>true</code>. By
    ...
    <div class="vx-col w-full md:w-1/2 lg:w-1/2 xl:w-1/2 md:mt-0">
      ...
      >
        <p class="mb-2">
          You can add all three action by setting
          <code>action-buttons</code> prop to <code>true</code>. By default it
          is set to false.
        </p>
        <p class="mb-1">
          Click on
