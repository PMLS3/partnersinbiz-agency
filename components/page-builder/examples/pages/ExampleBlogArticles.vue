...
<template>
  <body @click="addComponent('blog-article')" id="blog-article">
    <!-- header -->
    <header class="w-full px-6 bg-white">
      ...
      >
        <a
          href="#"
          class="py-6 w-full text-center md:text-left md:w-auto text-gray-dark no-underline flex justify-center items-center"
        >
          Your Logo
        </a>
    ...
    <!-- nav -->
    <nav
      class="w-full bg-white md:pt-0 px-6 relative z-20 border-t border-b border-gray-light"
    >
      <div
      ...
      >
        ...
        >
          <a
            href="#"
            class="px-2 md:pl-0 md:mr-3 md:pr-3 text-gray-700 no-underline md:border-r border-gray-light"
            >Home</a
          >
          <a
            href="#"
          ...
          <a
            href="#"
            class="px-2 md:pl-0 md:mr-3 md:pr-3 text-gray-darkest no-underline"
            >Contact</a
          >
        </div>
    ...
    <div class="w-full bg-white">
      ...
      <div
        class="container max-w-4xl mx-auto md:flex items-start py-8 px-12 md:px-0"
      >
        <!-- articles -->
        <div class="w-full md:pr-12 mb-12">
          <article class="mb-12">
            <h2 class="mb-4">
              <a
                href="#"
                class="text-black text-xl md:text-2xl no-underline hover:underline"
              >
            ...
            <div class="mb-4 text-sm text-gray-700">
              by <a href="#" class="text-gray-700">Joe Bloggs</a> on 19th March
              2019
          ...
          <div class="flex justify-between text-xs">
            <a
              href="#"
              class="bg-gray text-white no-underline py-2 px-3 rounded"
              >Previous</a
            >
            <a
              href="#"
              class="bg-black text-white no-underline py-2 px-3 rounded"
              >Next</a
            >
          </div>
        </div>
          ...
          <aside class="rounded shadow overflow-hidden mb-6">
            ...
            <div class="p-4">
              <ul class="list-reset leading-normal">
                <li>
                  <a href="#" class="text-gray-darkest text-sm"
                    >Uncategorised</a
                  >
                </li>
                <li>
                ...
                <li>
                  <a href="#" class="text-gray-darkest text-sm">Garden</a>
                </li>
      ...
      >
        ...
        <div class="pt-4 md:p-0 text-center md:text-right text-xs">
          <a href="#" class="text-black no-underline hover:underline"
            >Privacy Policy</a
          >
          <a href="#" class="text-black no-underline hover:underline ml-4"
            >Terms &amp; Conditions</a
          >
          <a href="#" class="text-black no-underline hover:underline ml-4"
            >Contact Us</a
