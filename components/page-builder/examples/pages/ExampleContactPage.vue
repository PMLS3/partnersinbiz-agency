...
<template>
  <body @click="addComponent('contact-page')" id="contact-page">
    <!-- header -->
    <header class="w-full px-6 bg-white">
      ...
      >
        <a
          href="#"
          class="block py-6 w-full text-center md:text-left md:w-auto text-gray-dark no-underline flex justify-center items-center"
        >
          Your Logo
        </a>
    ...
    <!-- nav -->
    <nav
      class="w-full bg-white md:pt-0 px-6 relative z-20 border-t border-b border-gray-300"
    >
      <div
      ...
      >
        ...
        >
          <a
            href="#"
            class="px-2 md:pl-0 md:mr-3 md:pr-3 text-gray-700 no-underline md:border-r border-gray-300"
            >Home</a
          >
          <a
            href="#"
      ...
      <div class="container max-w-4xl mx-auto pb-10 px-12 md:px-0">
        <div class="flex flex-wrap justify-start items-start -mx-4">
          <div class="w-full md:w-1/2 p-4">
            <form>
              <fieldset class="mb-4">
                ...
                <input
                  class="block w-full border rounded py-2 px-3 text-sm text-gray-700"
                  type="text"
                />
                <p class="text-xs pt-2 text-gray">
              ...
              <fieldset class="mb-4">
                ...
                <textarea
                  class="block w-full border border-red-300er rounded py-2 px-3 text-sm text-gray-700 h-32"
                ></textarea>
                <p class="text-xs pt-2 text-red-400">
                  This field is required...
                </p>
              </fieldset>

              <button class="text-sm py-2 px-3 bg-black text-white rounded">
                Submit
              </button>
            </form>
          </div>
          ...
          <div class="w-full md:w-1/2 p-4">
            ...
            <p class="text-black font-bold mb-1">My Company Ltd</p>
