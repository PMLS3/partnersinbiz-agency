...
<template>
  <body @click="addComponent('products-list')" id="products-list">
    <!-- header -->
    <header class="w-full px-6 bg-white">
      ...
      >
        ...
        <div class="w-full md:w-auto mb-6 md:mb-0 text-center md:text-right">
          <a
            href="#"
            class="inline-block no-underline bg-black text-white text-sm py-2 px-3"
            >Login / Regsiter</a
          >
        </div>
      </div>
      ...
      >
        ...
        <div class="w-full md:w-1/2 text-center md:text-right pb-4 md:p-0">
          <input
            type="search"
            placeholder="Search..."
            class="bg-gray-200 border text-sm p-1"
          />
        </div>
      </div>
    </nav>
    ...
    <!-- title -->
    <h1 class="text-center text-xl md:text-4xl px-6 py-12 bg-white">
      Our Products
    </h1>
    <!-- /title -->
    ...
    <div class="w-full px-6 py-12 bg-gray-100 border-t">
      <div
        class="container max-w-4xl mx-auto pb-10 flex justify-between items-center px-3"
      >
        <div class="text-xs">
          <a
            href="#"
            class="bg-gray-500 text-white no-underline py-1 px-2 rounded-lg mr-2"
            >Previous</a
          >
          ...
          <a
            href="#"
            class="bg-black text-white no-underline py-1 px-2 rounded-lg ml-2"
            >Next</a
          >
        </div>
