...
<script>
import RegisterJwt from './ExampleRegisterJWT.vue'
import RegisterFirebase from './ExampleRegisterFirebase.vue'
import RegisterAuth0 from './ExampleRegisterAuth0.vue'
