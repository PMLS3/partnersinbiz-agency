...
<template>
  <body @click="addComponent('home2')" id="home2">
    <!-- nav -->
    <nav class="w-full px-6 bg-white shadow-lg relative z-20">
      ...
      >
        ...
        <div class="pt-4">
          <a
            href="#"
            class="block w-16 h-16 md:w-24 md:h-24 rounded-full border-2 overflow-hidden"
          >
            <img
              src="https://images.unsplash.com/photo-1522322659370-3c98da30c99c?w=300"
    ...
    <div class="w-full px-6 py-12 bg-gray-600 text-gray-300">
      <div class="container max-w-lg mx-auto text-center">
        <p class="leading-normal mb-6">
          Thanks guys, keep up the good work! You won't regret it. After using
          Free Templates my business skyrocketed! I'd be lost without Free
          Templates.
        </p>
      ...
      <div class="container max-w-4xl mx-auto flex flex-wrap">
        <div class="w-full md:w-1/2 flex flex-wrap">
          <div class="w-full md:w-1/2 p-2">
            <img
              src="https://images.unsplash.com/photo-1486308510493-aa64833637bc?w=800"
              class="w-full h-48 object-cover"
            />
          </div>
          <div class="w-full md:w-1/2 p-2">
            <img
              src="https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=800"
              class="w-full h-48 object-cover"
            />
          </div>
          <div class="w-full md:w-1/2 p-2">
            <img
              src="https://images.unsplash.com/photo-1537832816519-689ad163238b?w=800"
              class="w-full h-48 object-cover"
            />
          </div>
          <div class="w-full md:w-1/2 p-2">
        ...
        <div class="w-full md:w-1/2 p-2 md:px-6">
          ...
          <a
            href="#"
            class="inline-block bg-black text-white text-sm px-4 py-3 no-underline"
    ...
    <footer class="w-full bg-gray-300 border-t">
      <div
        class="container mx-auto max-w-4xl h-full flex flex-wrap md:flex-no-wrap justify-between items-start text-sm p-6 pt-8 pb-4"
      >
        <div class="mb-4">
