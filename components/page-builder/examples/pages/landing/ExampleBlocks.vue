...
<template>
  <body
    @click="addComponent('blocks')"
    id="blocks"
    class="bg-gray-200 font-sans font-thin px-6 bg-fixed bg-cover bg-no-repeat"
    style="
      background-image: url('https://images.unsplash.com/photo-1523742238290-adf3b54101bf?w=1800');
    "
  >
    <header class="mx-auto max-w-xl py-20 text-center">
      <a href="#" class="block text-2xl mb-12">Company Name</a>

      <ul class="flex justify-center uppercase text-xs">
        <li>
          <a href="#" class="mx-4 hover:text-gray-600">Home</a>
        </li>
        <li>
          <a href="#" class="mx-4 text-gray-600">About</a>
        </li>
        <li>
          <a href="#" class="mx-4 hover:text-gray-600">Blog</a>
        </li>
        <li>
    ...
    <div
      class="mx-auto max-w-6xl bg-white py-20 px-12 lg:px-24 shadow-xl mb-24"
    >
      <div class="mb-12">
        <h1 class="text-3xl lg:text-4xl text-center mb-6 tracking-wider">
          About Us
        </h1>

        <p
          class="tracking-wide text-sm mb-6 leading-relaxed mx-auto max-w-xl text-center"
        >
          Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
          <br class="hidden md:block" />Aenean commodo ligula eget dolor.
        </p>

        <p
          class="tracking-wide text-xs text-gray-600 leading-loose mx-auto max-w-xl text-center"
        >
      ...
      <div class="flex flex-wrap -mx-2">
        <div class="w-1/3 p-2">
          <a href="#" class="block mb-8 bg-black hover:bg-gray-700">
            <img
              src="https://images.unsplash.com/photo-1499175898579-d743fea6e7dc?w=800"
              class="w-full h-auto opacity-75"
            />
          </a>
    ...
    <div class="-mx-6 bg-white px-6 py-12">
      <div class="mx-auto container text-gray-800 text-sm flex justify-between">
        <span
          >Powered by
          <a href="https://digizu.co.uk" class="text-black">Digizu</a></span
        >
