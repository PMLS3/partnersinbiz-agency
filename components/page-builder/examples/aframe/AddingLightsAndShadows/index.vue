<template>
     <!-- ******** For Light and Shadows, NOTHING HAS CHANGED WITH v1.0.4 ******** -->
        <!-- ******** For animating them, instead, SOME THINGS HAVE CHANGED WITH v1.0.4 ******** -->
        ...
        <a-scene>
            ...
            <a-assets>
                <img id="floor" src="@/assets/images/elements/floor-1024.jpg">
                <img id="firefox" src="@/assets/images/elements/firefox-quantum-1024.png">
                <!-- <a-asset-item id="room" src="assets/gltf/room.gltf"></a-asset-item> -->
            </a-assets>
...
export default {
  name: 'adding-lights-and-shadows',
