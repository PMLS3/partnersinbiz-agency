  ...
  <div id="extra-component-form-validation-demo">
    <p class="mb-4">
      <a
        ...
        >vee-validate</a
      >
      is a Template Based Validation Framework for Vue.js. Read full
      documentation
      <a
...
<script>
import FormValidationSimple from './ExampleFormValidationSimple.vue'
import FormValidationMultipleRules from './ExampleFormValidationMultipleRules.vue'
import FormValidationCustomErrorMessages from './ExampleFormValidationCustomErrorMessages.vue'
import FormValidationEvents from './ExampleFormValidationEvents.vue'
import FormValidationTypes from './ExampleFormValidationTypes.vue'
