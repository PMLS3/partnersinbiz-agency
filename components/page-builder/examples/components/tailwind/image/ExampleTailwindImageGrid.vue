          ...
          <div class="flex flex-row flex-wrap -mx-2">
            <div class="w-full md:w-1/2 h-64 md:h-auto mb-4 px-2">
              <a
                ...
                title="Link"
                style="
                  background-image: url(https://via.placeholder.com/800x600/EDF2F7/E2E8F0/&amp;text=Image);
                "
              >
                Link
              </a>
    ...
    <vx-card class="mt-8" title="Side by Side">
      ...
      <div class="demo-alignment">
        <section
          class="py-8 px-4"
          id="side-by-side"
          @click="addComponent('side-by-side')"
        >
          <div class="flex flex-wrap -mx-4">
    ...
    <vx-card class="mt-8" title="Three by Two">
      ...
      <div class="demo-alignment">
        <section
          class="pt-8 px-4"
          id="three-by-two"
          @click="addComponent('three-by-two')"
        >
          <div class="flex flex-wrap -mx-4">
    ...
    <vx-card class="mt-8" title="Four by Two">
      ...
      <div class="demo-alignment">
        <section
          class="py-8 px-4"
          id="four-by-two"
          @click="addComponent('four-by-two')"
        >
