...
<template>
  <vx-card title="Closable" code-toggler>
    ...
    <template slot="codeContainer">
      ...
      1&lt;/vs-button&gt; &lt;vs-button
      @click=&quot;active2=!active2&quot;&gt;{{
        !active2 ? 'Open Alert' : 'Close Alert'
      }}
      2&lt;/vs-button&gt; &lt;vs-alert :active.sync=&quot;active1&quot; closable
      icon-pack=&quot;feather&quot; close-icon=&quot;icon-x&quot;&gt; Chupa
      chups topping bonbon. Jelly-o toffee I love. Sweet I love wafer I love
      wafer. &lt;/vs-alert&gt; &lt;vs-alert :active.sync=&quot;active2&quot;
      closable close-icon=&quot;icon-x-circle&quot;
      icon-pack=&quot;feather&quot;&gt; Chupa chups topping bonbon. Jelly-o
      toffee I love. Sweet I love wafer I love wafer. &lt;/vs-alert&gt;
    </template>
  </vx-card>
</template>
