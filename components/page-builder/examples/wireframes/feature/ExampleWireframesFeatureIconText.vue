  ...
  >
    <div>
      <div class="flex items-center flex-col px-4">
        ...
        <h2
          class="text-4xl lg:text-5xl font-extrabold text-center leading-tight text-gray-800 lg:w-7/12 md:w-9/12 pt-4"
        >
      ...
      <div class="mt-20 flex flex-wrap justify-between px-4">
        ...
        <div class="flex sm:w-full md:w-5/12 pb-20">
          ...
          <div class="w-10/12">
            ...
            <p class="text-base text-gray-600 leading-normal pt-2">
              Instead of just giving you the tools to create your own site, they
              offer you a list of themes you can choose from. Thus a handy
              product.
            </p>
          </div>
        </div>
