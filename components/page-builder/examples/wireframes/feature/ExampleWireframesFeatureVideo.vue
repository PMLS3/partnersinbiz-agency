      ...
      <div class="flex flex-wrap items-center">
        ...
        <div class="lg:w-3/5 w-full">
          <div class="lg:pl-8 py-2 text-color">
            <h1 class="text-3xl xl:text-6xl leading-snug f-f-l font-black">
              Gather data to offer a bespoke solution
            </h1>
            <h2
              class="text-xl lg:text-3xl leading-7 lg:leading-10 f-f-r py-4 lg:py-8"
            >
              ...
              size fits all approach. I personally review each and every client
              business and oversee the team that tailores a solution
            </h2>
            <div class="flex items-center">
              ...
              <div class="pl-3">
                <h3 class="f-f-l text-xl lg:text-3xl">Rachel Dawson</h3>
                <h4 class="f-f-r text-lg pt-2">CEO, Globex Workspaces</h4>
              </div>
            </div>
          </div>
        </div>
