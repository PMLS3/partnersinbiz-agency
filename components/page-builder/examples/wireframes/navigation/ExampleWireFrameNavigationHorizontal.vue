    ...
    >
      <div class="flex items-center">
        ...
        <ul class="hidden xl:flex items-center h-full">
          <li
            class="cursor-pointer h-full flex items-center text-sm text-indigo-700 tracking-normal"
          >
            <span class="mr-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li
            class="cursor-pointer h-full flex items-center text-sm text-gray-800 hover:text-indigo-700 transition duration-150 ease-in-out mx-10 tracking-normal relative"
            @mouseenter="dropdownHandler($event)"
          >
            <ul
          ...
          <li
            class="cursor-pointer h-full flex items-center text-sm text-gray-800 hover:text-indigo-700 transition duration-150 ease-in-out mr-10 tracking-normal"
          >
            <span class="mr-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li
            class="cursor-pointer h-full flex items-center text-sm text-gray-800 hover:text-indigo-700 transition duration-150 ease-in-out tracking-normal relative"
            @mouseenter="dropdownHandler($event)"
          >
            <ul
              class="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute hidden top-0"
      ...
      <div class="h-full hidden xl:flex items-center justify-end">
        <div class="h-full flex">
          <div
            class="text-gray-600 px-6 h-full justify-center border-l border-gray-300 flex items-center"
          >
            <input
              type="text"
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              class="icon icon-tabler icon-tabler-search cursor-pointer"
              width="28"
              height="28"
              viewBox="0 0 24 24"
              stroke-width="1.5"
          ...
          <div
            class="text-gray-600 w-20 h-full flex items-center justify-center border-l border-r border-gray-300 cursor-pointer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            class="text-gray-600 w-20 h-full flex items-center justify-center border-r border-gray-300 cursor-pointer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
