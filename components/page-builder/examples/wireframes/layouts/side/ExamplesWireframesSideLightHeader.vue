<template>
  <div>
    <div class="relative flex flex-no-wrap bg-gray-200">
      ...
      <div
        class="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex pb-12"
      >
        <div class="px-8">
          ...
          <ul class="mt-12">
            ...
            <li
              class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center"
            >
              <div class="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <div
        class="w-64 z-20 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden pb-12 transition duration-150 ease-in-out"
        id="mobile-nav"
      >
        <div
          id="openSideBar"
