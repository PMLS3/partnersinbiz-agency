  ...
  <div>
    <div class="flex flex-no-wrap bg-gray-200">
      ...
      <div class="absolute sm:relative w-64 shadow bg-white hidden sm:block">
        ...
        <ul aria-orientation="vertical" class="bg-white rounded py-6">
          <li
            class="pl-6 cursor-pointer text-white text-sm leading-3 tracking-normal pb-4 pt-5 bg-indigo-700 focus:text-indigo-700 focus:outline-none"
          >
            ...
            <ul class="pt-2">
              <li
                class="pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2"
              >
                Stats
              </li>
              <li
              ...
              <li
                class="pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 flex items-center ml-2"
              >
                Tables
              </li>
            </ul>
          ...
          <li
            class="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <li
            class="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <li
            class="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div
        class="absolute z-40 sm:relative w-64 shadow bg-white sm:hidden transition duration-150 ease-in-out"
        id="mobile-nav"
      >
        <div
          id="openSideBar"
          class="h-10 w-10 bg-white absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-indigo-700"
        ...
        <div
          id="closeSideBar"
          class="hidden h-10 w-10 bg-white absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-indigo-700"
      ...
      <div class="w-full">
        ...
        >
          ...
          >
            <ul
              class="w-40 border-r bg-white absolute rounded right-0 p-4 shadow mt-12 hidden"
            >
              <li
                class="pl-2 flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center"
              >
                <div class="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li
                class="pl-2 flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center mt-2"
              >
                <div class="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
