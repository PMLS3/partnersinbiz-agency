<template>
  <div>
    ...
    >
      <div
        class="container px-6 h-16 flex items-center justify-between mx-auto"
      >
        <div class="flex items-center">
          <div class="rounded-full relative p-3 flex justify-end text-white">
            <input
              type="text"
              class="bg-transparent focus:outline-none text-xs w-0 transition duration-150 ease-in-out absolute left-0 ml-10"
        ...
        <ul class="flex items-center justify-center h-full">
          <li
            class="cursor-pointer h-full xl:flex items-center text-sm text-indigo-500 tracking-normal hidden"
          >
            Dashboard
          </li>
          <li
            class="hover:text-indigo-500 cursor-pointer h-full xl:flex items-center text-sm text-white xl:ml-10 tracking-normal hidden relative"
          ...
          <li
            class="hover:text-indigo-500 cursor-pointer h-full xl:flex items-center text-sm text-white mr-10 tracking-normal hidden"
          >
            Performance
          </li>
          <li
            class="hover:text-indigo-500 cursor-pointer h-full xl:flex items-center text-sm text-white tracking-normal hidden"
          >
            Deliverables
          </li>
        </ul>
        ...
        >
          <ul
            class="p-2 w-40 border-r bg-white absolute rounded z-40 right-0 shadow mt-64 hidden"
          >
            <li
        ...
        <div class="visible xl:hidden flex items-center">
          ...
          >
            ...
            <li
              class="xl:hidden flex-col cursor-pointer text-gray-600 text-base leading-3 tracking-normal py-3 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center"
              @click="dropdownHandler($event)"
            >
              <div class="flex items-center">
            ...
            <li
              class="xl:hidden cursor-pointer text-gray-600 text-base leading-3 tracking-normal mb-2 py-3 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none"
            >
    ...
    <div class="relative z-10 bg-gray-800 pt-8 pb-16">
      ...
      >
        ...
        <div class="mt-6 lg:mt-0">
          ...
          <button
            class="focus:outline-none transition duration-150 ease-in-out hover:bg-gray-200 border bg-white rounded text-indigo-700 px-8 py-2 text-sm"
          >
            Edit Profile
          </button>
        </div>
          ...
          <div class="w-full -mt-8 h-auto">
            <div class="w-full h-auto lg:h-20 mb-6 rounded shadow bg-white">
              ...
              <ul class="hidden lg:flex flex-row items-center h-full">
                <li
                  class="ml-4 my-2 lg:my-0 rounded text-base text-gray-800 px-4 py-2 bg-gray-200"
                >
                  Quarterly
                </li>
                ...
                <li class="pl-10 my-0 text-base text-gray-600">
                  History Sheet
                </li>
                <li class="pl-10 my-0 text-base text-gray-600">
                  Account Settings
            ...
            <div class="container mx-auto h-64">
              <div class="bg-white w-full h-full rounded shadow">
...
<script>
export default {
  name: 'DarkWithBorderAbovePageTitle',
}
</script>
