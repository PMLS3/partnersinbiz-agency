    ...
    <div class="px-5 xl:px-10 pb-10">
      <div class="flex justify-center xl:justify-end w-full pt-16 xl:pt-5">
        <div class="flex items-center">
          <svg
            class="w-4 mr-1 text-yellow-400 icon icon-tabler icon-tabler-star"
          ...
          <svg
            class="w-4 text-gray-200 icon icon-tabler icon-tabler-star"
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
            viewBox="0 0 24 24"
      ...
      >
        <div class="xl:pr-16 w-full xl:w-2/3">
          ...
          >
            <h2
              class="mb-3 xl:mb-0 xl:mr-4 text-2xl text-gray-800 font-medium tracking-normal"
            >
              Marshall Mathers
            </h2>
            <div
              class="text-sm bg-indigo-700 text-white px-5 py-1 font-normal rounded-full"
            >
              Pro
            </div>
          </div>
          <p
            class="text-center xl:text-left mt-2 text-sm tracking-normal text-gray-600 leading-5"
          >
        ...
        >
          <div class="mr-6 xl:mr-10">
            <h2
              class="text-gray-600 font-bold text-xl xl:text-2xl leading-6 mb-2 text-center"
            >
              82
            </h2>
            <p class="text-gray-800 text-sm xl:text-xl leading-5">Reviews</p>
          </div>
          <div class="mr-6 xl:mr-10">
            <h2
              class="text-gray-600 font-bold text-xl xl:text-2xl leading-6 mb-2 text-center"
            ...
            <p class="text-gray-800 text-sm xl:text-xl leading-5">Projects</p>
          </div>
          <div>
            <h2
              class="text-gray-600 font-bold text-xl xl:text-2xl leading-6 mb-2 text-center"
            ...
            <p class="text-gray-800 text-sm xl:text-xl leading-5">Approved</p>
          </div>
        </div>
        <div
        ...
        >
          ...
          >
            <div
              class="rounded-full bg-gray-200 text-gray-600 text-sm px-6 py-2 flex justify-center items-center"
            >
              Remote
            </div>
            <div
...
export default {
  ...
  data() {
    return {
      header:
        'https://tuk-cdn.s3.amazonaws.com/assets/components/grid_cards/gc_29.png',
      profilePhoto:
