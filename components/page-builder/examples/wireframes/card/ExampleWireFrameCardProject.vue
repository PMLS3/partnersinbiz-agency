<template>
  ...
  >
    <div class="w-full lg:w-1/3 p-6">
      <div class="flex items-center">
        ...
        <div class="ml-3">
          ...
          <p class="text-gray-600 text-xs font-normal">San Diego, California</p>
        </div>
      </div>
      ...
      <p class="text-gray-600 text-sm font-normal">
        To many naive users of the platform, a redesign may look just like a
        facelift. No more, no less. However, for a User Experience designer, the
        entire redesign process means much more than a lot of research,
    ...
    >
      ...
      <div class="mt-6 mb-8 w-full bg-gray-100 rounded p-4 relative">
        <ul>
          <li class="text-xs text-gray-600 font-normal tracking-normal">
            - Visual QA for all design components
          </li>
          <li class="text-xs text-gray-600 font-normal tracking-normal my-4">
            - UX overview of new product launch
          </li>
          <li class="text-xs text-gray-600 font-normal tracking-normal">
            - Visual QA for all design components
          </li>
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-gray-800 text-sm leading-5 text-center">Milestones</p>
        </div>
        <div>
          <h2
            class="text-gray-600 font-bold text-lg leading-6 mb-1 text-center"
    ...
    <div class="w-full lg:w-1/3 p-6">
      <div class="mb-4 flex items-center justify-between">
        <p class="text-gray-600 text-sm font-normal leading-3 tracking-normal">
          User Experience Research
        </p>
        <p
          class="text-xs text-indigo-700 font-normal leading-3 tracking-normal"
        >
          7/12
        </p>
      </div>
      ...
      <div class="mb-4 flex items-center justify-between">
        ...
        <p
          class="text-xs text-indigo-400 font-normal leading-3 tracking-normal"
        >
          3/12
        </p>
      </div>
