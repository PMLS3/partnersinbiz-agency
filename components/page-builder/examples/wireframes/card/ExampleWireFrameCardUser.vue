      ...
      <div class="w-full md:w-1/2 lg:w-1/4">
        ...
        <div class="bg-white shadow rounded">
          <div class="pt-4 px-4 flex items-center justify-between pb-8">
            <p class="text-indigo-700 font-normal text-xs">UX Design</p>
            <div class="flex items-center">
              <svg
                class="w-3 mr-1 text-yellow-400 icon icon-tabler icon-tabler-star"
              ...
              <svg
                class="w-3 text-gray-200 icon icon-tabler icon-tabler-star"
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
                viewBox="0 0 24 24"
          ...
          <div class="flex justify-center w-full mb-6">
            <p
              class="py-2 px-5 bg-indigo-700 rounded-full leading-4 flex justify-center items-center text-sm leaing-3 text-white"
            >
              Professional
            </p>
          </div>
...
export default {
  ...
  data() {
    return {
      profilePhoto:
        'https://tuk-cdn.s3.amazonaws.com/assets/components/grid_cards/gc_2.png',
    }
  },
}
</script>
