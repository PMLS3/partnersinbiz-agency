      ...
      >
        <div class="xl:w-full border-b border-gray-300 py-5">
          <div class="flex items-center w-11/12 mx-auto">
            <p class="text-lg text-gray-800 font-bold">Personal Information</p>
          ...
          <div class="container mx-auto">
            <div class="my-8 mx-auto xl:w-full xl:mx-0">
              <div class="xl:flex lg:flex md:flex flex-wrap justify-between">
                ...
                <div class="xl:w-2/5 lg:w-2/5 md:w-2/5 flex flex-col mb-6">
                  ...
                  <div class="relative">
                    ...
                    <input
                      ...
                      name="email"
                      required
                      class="w-full text-gray-800 focus:outline-none focus:border focus:border-indigo-700 font-normal py-3 flex items-center pl-16 text-sm border-green-400 rounded border shadow"
                ...
                <div class="xl:w-2/5 lg:w-2/5 md:w-2/5 flex flex-col mb-6">
                  <label for="City" class="pb-2 text-sm font-bold text-gray-800"
                    >City</label
                  >
                  <div
                  ...
                  >
                    <select
                      ...
                      required
                      id="City"
                      class="bg-transparent appearance-none z-10 pl-3 py-3 w-full text-sm border border-transparent focus:outline-none focus:border-indigo-700 text-gray-800 rounded"
                    >
              ...
              <div class="xl:w-2/5 lg:w-2/5 md:w-2/5 flex flex-col mb-6">
                ...
                <input
                  ...
                  id="ZIP"
                  name="zip"
                  class="border border-red-400 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 text-gray-800"
