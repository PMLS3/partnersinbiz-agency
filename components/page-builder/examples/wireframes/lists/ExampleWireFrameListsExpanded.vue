  ...
  <div class="mx-auto container">
    <div>
      <div class="flex pt-6 items-center">
        ...
        <h1 class="text-lg text-gray-900 font-semibold ml-3">Overdue</h1>
      </div>
      <ul class="pt-6">
        <div v-for="idx in 3" v-bind:key="idx">
          <li class="md:flex justify-between items-center">
            <div class="flex items-center text-gray-400 w-full md:w-1/2">
              ...
              <p class="text-gray-600 font-semibold">{{ overdue[0].title }}</p>
            </div>
            <div
              class="md:flex items-center md:w-1/2 w-full justify-end text-gray-700"
            >
              <p class="text-red-500 mt-4 md:mt-0 mr-10">
                Due today at {{ overdue[0].time }}
              </p>
    ...
    <hr class="hidden divider mt-6 border-t border-gray-300" />
    <div>
      <div class="flex pt-6 items-center">
        <div data-menu class="cursor-pointer">
          <svg
        ...
        <h1 class="text-lg text-gray-900 font-semibold ml-3">Urgent</h1>
      </div>
      <ul class="pt-6">
        <div v-for="idx in 3" v-bind:key="idx">
          <li class="md:flex justify-between items-center">
            <div class="flex items-center text-gray-400 w-full md:w-1/2">
              ...
              <p class="text-gray-600 font-semibold">{{ urgent[0].title }}</p>
            </div>
            <div
              class="md:flex items-center md:w-1/2 w-full justify-end text-gray-700"
            >
              <p class="text-yellow-600 mt-4 md:mt-0 mr-10">
                Due today at {{ urgent[0].time }}
              </p>
              <div class="mt-4 md:mt-0 flex items-center">
                <div class="mr-3">
                  <svg
