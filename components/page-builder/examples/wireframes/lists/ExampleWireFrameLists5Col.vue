  ...
  >
    <div class="w-full overflow-x-scroll xl:overflow-x-hidden">
      <table class="min-w-full bg-white">
        <thead>
          <tr class="w-full h-16 bg-gray-800 py-8">
            <th
              class="rounded-l-lg pl-3 w-12 text-gray-300 font-normal text-left tracking-normal leading-4 opacity-0"
            >
              <div class="flex items-center">
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="-ml-3 icon icon-tabler icon-tabler-dots-vertical"
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
            ...
            <th
              class="text-gray-300 font-normal pr-6 text-left tracking-normal leading-4"
            >
              <div
                class="bg-gray-800 border rounded-sm border-gray-300 w-5 h-5 flex flex-shrink-0 justify-center items-center relative"
                @click="checkAll()"
              >
                <input
                  type="checkbox"
                ...
                />
                <div
                  class="check-icon hidden bg-yellow-400 text-white rounded-sm"
                >
                  <svg
            ...
            <th
              class="cursor-pointer text-gray-300 font-normal pr-6 text-left tracking-normal leading-4"
            >
              Todos
            </th>
            <th
            ...
            <th
              class="rounded-r-lg text-gray-300 font-normal pr-8 text-left tracking-normal leading-4"
            >
              More
            </th>
          </tr>
        ...
        <tbody>
          <tr
            v-for="row in 7"
            v-bind:key="row"
            class="h-20 border-gray-300 border-b"
          >
            <td
              class="pl-3 text-gray-600 font-normal text-left tracking-normal leading-4"
            >
              <div class="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <td
              class="pr-6 text-left whitespace-no-wrap text-gray-800 tracking-normal leading-4"
            >
              <div
            ...
            <td
              class="font-semibold text-sm pr-10 whitespace-no-wrap text-gray-800 tracking-normal leading-4"
            >
              <a href="">{{ tableData[0].title }}</a>
            </td>
            <td
              class="text-sm pr-6 whitespace-no-wrap text-gray-800 tracking-normal leading-4 font-semibold"
            >
              {{ tableData[0].todos }}
            </td>
            <td
            ...
            <td class="pr-8 relative">
              ...
              >
                <ul class="bg-white shadow rounded py-1">
                  <li
                    class="cursor-pointer text-gray-600 leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal"
                  >
                    Edit
                  </li>
                  <li
              ...
              >
                <svg
                  @click="dropdownFunction($event)"
                  xmlns="http://www.w3.org/2000/svg"
                  class="icon icon-tabler icon-tabler-dots dropbtn"
                  width="28"
                  height="28"
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
