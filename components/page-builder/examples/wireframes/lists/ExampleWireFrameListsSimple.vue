  ...
  <div class="w-full h-full bg-gray-200">
    <div class="container mx-auto px-6 py-10">
      <div class="sm:shadow rounded bg-white">
        <div
          class="xl:w-full w-11/12 mx-auto flex flex-wrap items-center justify-between px-8 mb-2 xl:mb-0 lg:mb-0 border-b border-gray-300"
        >
          <div class="xl:w-1/5 py-5">
            <div class="flex items-center">
              <div class="w-12 h-12 rounded">
                <img
                  src="https://cdn.tuk.dev/assets/photo-1575978108872-9b1429a19a0f.jfif"
                  alt=""
                  class="h-full w-full object-cover rounded overflow-hidden shadow"
                />
              </div>
              <p class="text-lg text-gray-800 pl-2 font-normal">
                Jonathan Stark
              </p>
            </div>
          </div>
          <div class="xl:w-1/5 py-5">
            <div class="flex items-center">
              ...
              <p class="text-sm text-gray-600 pl-2 font-normal">
                jonathanstark97@gmail.com
              </p>
            </div>
          </div>
          <div class="xl:w-1/5 py-5">
        ...
        <div
          class="xl:w-full w-11/12 mx-auto flex flex-wrap items-center justify-between px-8 mb-2 xl:mb-0 lg:mb-0"
        >
          <div class="xl:w-1/5 py-5">
            <div class="flex items-center">
              <div class="w-12 h-12 rounded">
