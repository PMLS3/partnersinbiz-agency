<template>
  <div @click="addComponent('overlay-modal')" id="overlay-modal">
    <div
    ...
    >
      <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
        <div
          class="relative py-8 px-8 md:px-16 bg-white shadow-md rounded border border-gray-400"
        >
          ...
          <h1
            class="text-center text-gray-800 font-lg font-bold tracking-normal leading-tight mb-4"
          >
            Payment Processing Successful
          </h1>
          <p class="mb-5 text-sm text-gray-600 text-center font-normal">
          ...
          <div class="flex items-center justify-center w-full">
            ...
            <button
              class="focus:outline-none ml-3 bg-gray-100 transition duration-150 text-gray-600 ease-in-out hover:border-gray-400 hover:bg-gray-300 border rounded px-4 sm:px-8 py-2 text-xs sm:text-sm"
