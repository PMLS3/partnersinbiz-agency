<template>
  ...
  >
    <div class="flex flex-wrap rounded-lg">
      ...
      >
        <h1 class="font-extrabold text-4xl text-white pb-2">
          Our Happy Clients
        </h1>
      ...
      <div
        class="lg:w-3/5 xl:w-3/5 bg-gray-200 pl-4 pt-4 pb-4 pr-4 xl:pr-10 xl:pl-0 xl:pt-10 xl:pb-10 xl:rounded-tr xl:rounded-br"
      >
        <section id="carousel">
          <figure class="visible">
            <div class="relative bg-white">
              ...
              <div class="pt-20 px-6 sm:px-12">
                <p class="text-gray-600 text-base pb-6">
                  From local banks to local government, we partner with
                  organizations on their journey to digital transformation. Our
                  customers include 15 million professionals in 175 countries
                  and 800 of the fortune 1000.
                </p>
                <p class="text-gray-600 text-base pb-8">
                  We can't believe how far we have come in the last 6 months. I
                  really did not think this awesome career move would come so
                  quickly. Thanks to each of you put into SI and the partner
                  relationships.
                </p>
                <div class="flex items-center justify-between">
                  <div class="flex items-center pb-12">
                    ...
                    <p class="text-gray-600 font-bold ml-3">
                      Jane Doe
                      <br />
                      <span class="text-gray-600 text-base font-light"
                        >Apple Inc</span
                      >
                    </p>
                  </div>
          ...
          <figure class="hidden">
            <div class="relative bg-white">
              ...
              <div class="pt-20 px-6 sm:px-12">
                <p class="text-gray-600 text-base pb-6">
                  It's not just a pretty face but I am also thrilled by the
                  quality of support. It's fast reliable and has no
                  complications at all. It has completely changed the way I
                  develop a website . It lets you create anything you envision
                  and it does so easily and flawlessly.
                </p>
                <p class="text-gray-600 text-base pb-8">
                  Undoubtedly working with them was just like playing. It was so
                  easy editing your content, so fast getting perfect results and
                  so easy customizing based on your own brand.Thank you so much.
                </p>
                <div class="flex items-center justify-between">
                  <div class="flex items-center pb-12">
                    <div class="h-12 w-12">
