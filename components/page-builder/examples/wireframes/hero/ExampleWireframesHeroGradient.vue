<template>
  <div class="relative py-16">
    ...
    />
    <div class="mx-auto container px-4 xl:px-0 relative z-10">
        ...
        >
          ...
          <div class="flex items-center text-white text-lg font-bold">
            <ul class="flex items-center pr-12">
              ...
              <li class="lg:pl-5 xl:pl-8 cursor-pointer">
      ...
      <div class="py-12 lg:py-24">
        <h1
          class="text-center f-f-l text-white text-4xl md:text-8xl font-black"
        >
          How can we help?
        </h1>
        <div class="flex w-full h-full justify-center">
          <div
            class="mt-5 md:mt-20 w-9/12 lg:w-6/12 pl-4 md:pl-5 h-full bg-white flex items-center"
          >
            <div class="pr-2 md:pr-4">
              ...
              >
                <path
                  d="M22.0414 20.1561L27.752 25.8654L25.8654 27.7521L20.156 22.0414C18.0317 23.7444 15.3894 24.6706 12.6667 24.6667C6.04269 24.6667 0.666687 19.2907 0.666687 12.6667C0.666687 6.04275 6.04269 0.666748 12.6667 0.666748C19.2907 0.666748 24.6667 6.04275 24.6667 12.6667C24.6706 15.3894 23.7443 18.0317 22.0414 20.1561ZM19.3667 19.1667C21.0588 17.4266 22.0038 15.094 22 12.6667C22 7.50941 17.8227 3.33341 12.6667 3.33341C7.50935 3.33341 3.33335 7.50941 3.33335 12.6667C3.33335 17.8227 7.50935 22.0001 12.6667 22.0001C15.0939 22.0039 17.4265 21.0589 19.1667 19.3667L19.3667 19.1667Z"
                  fill="#4A5568"
                ></path>
              </svg>
            </div>
            <input
              class="h-16 md:h-20 w-full text-sm md:text-2xl f-f-r focus:outline-none text-color"
