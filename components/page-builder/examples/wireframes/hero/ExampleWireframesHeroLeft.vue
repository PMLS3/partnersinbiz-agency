    ...
    <div class="mx-auto container relative px-6 xl:px-0">
      <nav>
        <div class="lg:flex justify-between w-full py-12 hidden">
          ...
          <div class="lg:w-2/3 xl:w-1/2">
            <ul
              class="font-normal text-lg flex justify-between items-center text-gray-700"
            >
              <li class="text-indigo-700 cursor-pointer">
        ...
        <div class="flex py-2 justify-between items-center">
          ...
          <div class="visible flex items-center">
            ...
            >
              ...
              >
                <a href="javascript:void(0)">
                  <span class="ml-2 font-bold">Insurances</span>
                </a>
              </li>
              <li
              ...
              >
                <a href="javascript:void(0)">
                  <span class="ml-2 font-bold">Testimonials</span>
                </a>
              </li>
              <li
                class="flex flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center"
              ...
              >
                <a href="javascript:void(0)">
                  <span class="ml-2 font-bold">FAQ’s</span>
                </a>
              </li>
              <li
      ...
      >
        <div class="xl:mt-8">
          ...
          >
            <h1 class="mt-2 lg:mt-0">Trustworthy</h1>
            <h1 class="mt-2 lg:mt-0 text-indigo-700">Insurance</h1>
            <h1 class="mt-2 lg:mt-0">Providers</h1>
          </div>
          <h2
            class="text-lg lg:text-2xl tracking-wide leading-9 lg:w-10/12 mt-2 lg:mt-6 text-gray-700"
          >
            Jubilee Life Insurance makes it to the Top 25 Companies lists
          </h2>
          <button
            class="flex items-center relative focus:outline-none justify-center mt-5 lg:mt-10 text-lg lg:text-2xl font-medium text-white p-4 lg:p-8 bg-indigo-700 rounded-3xl"
          >
            Get a quote
            <svg
              class="ml-8"
        ...
        <div
          class="w-full custom-height bg-indigo-100 mt-8 lg:mt-0 rounded-3xl relative"
        >
          <img
            class="w-full"
