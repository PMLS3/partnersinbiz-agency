...
export default {
  ...
  computed: {
    simpleCalendarEvents() {
      return this.$store.state.example.events
    },
    validForm() {
      return (
        this.title !== '' &&
    ...
    calendarLabels() {
      return this.$store.state.example.eventLabels
    },
    labelColor() {
      return label => {
  ...
  methods: {
    addEvent() {
      ...
      this.$store.dispatch('example/addEvent', obj)
    },
    updateMonth(val) {
    ...
    openEditEvent(event) {
      const e = this.$store.getters['example/getEvent'](event.id)
      this.id = e.id
      this.title = e.title
    ...
    editEvent() {
      ...
      obj.classes = `event-${this.labelColor(this.labelLocal)}`
      this.$store.dispatch('example/editEvent', obj)
    },
    removeEvent() {
      this.$store.dispatch('example/removeEvent', this.id)
    },
    eventDragged(event, date) {
      this.$store.dispatch('example/eventDragged', { event, date })
    }
  },
  created() {
    // this.$store.registerModule('example', moduleCalendar)
    this.$store.dispatch('example/fetchEvents')
    this.$store.dispatch('example/fetchEventLabels')
  }
}
</script>
