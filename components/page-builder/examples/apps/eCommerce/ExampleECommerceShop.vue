...
export default {
  components: {
    ItemGridView: () => import('./components/ExampleItemGridView.vue'),
    ItemListView: () => import('./components/ExampleItemListView.vue'),
    AisClearRefinements,
    AisConfigure,
    AisHierarchicalMenu,
    AisHits,
  ...
  methods: {
    ...
    additemInCart(item) {
      this.$store.dispatch('example/additemInCart', item)
    },
