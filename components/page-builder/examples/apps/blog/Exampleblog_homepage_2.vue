<!-- =========================================================================================
    File Name: wn-alert.vue
    Component: wn-alert
    Description: Set up Alerts in app
    TODO: Alert needs to be global
    ----------------------------------------------------------------------------------------
            ...
            <div class="w-full lg:w-2/3">
              ...
              >
                ...
                >
                  <div>
                    <div
                      class="mt-3 md:mt-0 text-gray-700 font-bold text-2xl mb-2"
                    >
              ...
              <div class="mb-4">
                ...
                <ul>
                  ...
                  >
                    ...
                    >
                      <span
                        class="inline-block h-4 w-4 bg-green-300 mr-3"
                      ></span>
                      Nutrition
                  ...
                  >
                    ...
                    >
                      <span
                        class="inline-block h-4 w-4 bg-indigo-300 mr-3"
                      ></span>
                      Food & Diet
                  ...
                  >
                    ...
                    >
                      <span
                        class="inline-block h-4 w-4 bg-yellow-300 mr-3"
                      ></span>
                      Workouts
                  ...
                  >
                    ...
                    >
                      <span
                        class="inline-block h-4 w-4 bg-blue-300 mr-3"
                      ></span>
                      Immunity
