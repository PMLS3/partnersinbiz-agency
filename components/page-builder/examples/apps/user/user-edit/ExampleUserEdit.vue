...
<script>
import UserEditTabAccount from './ExampleUserEditTabAccount.vue'
import UserEditTabInformation from './ExampleUserEditTabInformation.vue'
import UserEditTabSocial from './ExampleUserEditTabSocial.vue'
...
export default {
  ...
  watch: {
    activeTab() {
      this.fetch_user_data(268)
    },
  },
  methods: {
    fetch_user_data(userId) {
      this.$store
        .dispatch('example/fetchUser', userId)
        .then((res) => {
