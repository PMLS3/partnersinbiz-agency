    ...
    <div id="ag-grid-demo">
      ...
      >
        <div class="px-6 pb-12">
          <extra-info :choices="choices" :item="item" :item_id="item_id" />
...
export default {
  name: 'gridTable',
  props: ['item', 'schema', 'columnDefs', 'item_id', 'choices'],
  components: {
    AgGridVue,
    ExtraInfo,
  },
  ...
  computed: {
    ...
    filterAll() {
      return this.$store.state.form.filter_all
    },
  },
  watch: {
  ...
  methods: {
    ...
    addForm() {
      ...
      let form = { ...this.formData, ...this.filterAll }
