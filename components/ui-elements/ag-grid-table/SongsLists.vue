    ...
    <div class="p-6 vx-card">
      <div class="flex flex-wrap items-center">
          ...
          <vs-dropdown vs-trigger-click class="cursor-pointer">
            ...
            >
              <span class="mr-2"
                ...
                -
                {{
                  music.length - currentPage * paginationPageSize > 0
                    ? currentPage * paginationPageSize
                    : music.length
                }}
                of {{ music.length }}</span
              >
        ...
        <vs-dropdown vs-trigger-click class="cursor-pointer">
          ...
          <vs-dropdown-menu>
            <vs-dropdown-item @click="getSelectedRows()">
...
import CellRendererAudio from './cell-renderer/CellRendererAudio.vue'
