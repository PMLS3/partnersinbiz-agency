<template>
  <div>
    <div class="w-full vx-col mb-base">
      <vx-card :title="loyal.title" style="width: 100%">
        <!-- CARD ACTION -->
    ...
    <vs-popup class="holamundo" :title="loyal.title" :active.sync="popupActivo">
    ...
    >
      <h1>Congrats!!!</h1>
      <p>You have received enough stamps for a free massage!</p>
      <p>Please take this to reception to claim your prize</p>
...
export default {
  ...
  computed: {
    ...
    route() {
      return this.$store.getters['feature/route']
    },
    companyDetails() {
