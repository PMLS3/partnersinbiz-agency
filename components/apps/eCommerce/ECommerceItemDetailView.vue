...
import carousel from '@/components/page-generator/components/components/extra-components/carousel/CarouselMultipleSlidesPerView.vue'
export default {
  components: {
    swiper,
    swiperSlide,
  ...
  computed: {
    ...
    schema() {
      let schema = {
        content: {
          title: this.item_data.product_name,
          images: this.item_data.images,
        },
      }
      return schema
    },
