...
const favorite = () => {
  let params = {
    q:
      '@nodejs OR #nodejs OR #angularjs OR #mongodb OR @angular OR #angular OR @mongodb OR #meanstack OR @npmjs OR #ionicframework OR @Ionicframework OR @NodeUp OR @nodeweeklyfeed',
    result_type: 'recent',
    lang: 'en',
  }
